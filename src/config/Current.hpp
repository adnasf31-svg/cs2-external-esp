...
namespace cfg {
	...
	namespace aimbot {
		...
		inline float smooth = 0.7f;
		inline float rcs_scale_x = 1.f;
		inline float rcs_scale_y = 1.f;
		inline int rcs_bullet = 1;
		inline int hotkey = 0;
		inline bool use_recoil_control = true;
	}
	...
	namespace settings {
		...
		inline int window_width = 760;
		inline int window_height = 520;
